...
Madelynn Dickerson, the information resources coordinator at the Claremont Colleges Library, approached our professor, Mariam Salloum, with the idea of a project that students in the class Big Data: Applications/Platforms could help complete. The library received funding from the Hive in order to begin a project that can be found [here](http://madelynndickerson.wixsite.com/dh4collections). Dickerson described the project as such:
